...
def main(args):
    ...
    save_path = {
        ...
        'model_dir':f'/home/cecnl/ljchang/CECNL/sustained-attention/model/test/{args["method"]}{args["backbone"]}_{args["num_window"]}window_{args["pairing"]}pair_within_subject_{args["EEG_ch"]}ch_ccc/',
        'log_file':f'log/test/{args["method"]}_{args["backbone"]}_{args["num_window"]}window_{args["pairing"]}pair_within_subject_{args["EEG_ch"]}ch_ccc.csv',
